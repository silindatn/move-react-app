          ...
          <Col>
            <Card>
              ...
              <CardBody>
                ...
                <Modal style={{overflow: 'auto'}} isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
                ...
                <Modal style={{overflow: 'auto'}} isOpen={this.state.large} toggle={this.toggleLarge}
                ...
                <Modal style={{overflow: 'auto'}} isOpen={this.state.small} toggle={this.toggleSmall}
                ...
                <Modal style={{overflow: 'auto'}} isOpen={this.state.primary} toggle={this.togglePrimary}
                ...
                <Modal style={{overflow: 'auto'}} isOpen={this.state.success} toggle={this.toggleSuccess}
                ...
                <Modal style={{overflow: 'auto'}} isOpen={this.state.warning} toggle={this.toggleWarning}
                ...
                <Modal style={{overflow: 'auto'}} isOpen={this.state.danger} toggle={this.toggleDanger}
                ...
                <Modal style={{overflow: 'auto'}} isOpen={this.state.info} toggle={this.toggleInfo}
